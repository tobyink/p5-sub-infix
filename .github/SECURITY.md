# Sub-Infix Security Policy

The [latest stable release on CPAN](https://metacpan.org/release/Sub-Infix)
...
[the Changes file on CPAN](https://metacpan.org/changes/distribution/Sub-Infix)
